...
---
  ...
  Weka(Waikato Environment for Knowledge Analysis) provides access to deep learning with WekaDeeplearning4j which uses [Deeplearning4j]({{< ref "eclipse-deeplearning4j" >}}).
