...
note: |
  * [Apache Spark](/softwares/apache-spark/) is a prerequisite for installing Apache SystemML. Hence, [platforms for which Apache Spark is available](/softwares/apache-spark/#platform) are considered for Apache SystemML.
---
