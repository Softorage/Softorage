...
sysreq:
  linux:
    -
      ...
      recm: "RAM: 1GB"
    -
      min: "Processor speed: 700MHz"
      recm: "Processor speed: 2GHz"
  macos:
    -
      min: "RAM: 1GB (2GB for OS X 10.7 and later or macOS)"
      recm: "RAM: 2GB (4GB for OS X 10.7 and later or macOS)"
    -
      min: "Processor speed: 1GHz (2GHz for OS X 10.7 and later or macOS)"
      recm: "Processor speed: 2GHz"
  windows:
    -
      min: "RAM: 512MB to 1GB"
      recm: "RAM: 2GB to 4GB"
    -
      min: "Processor speed: 1GHz "
      recm: "Processor speed: 1GHz to 2GHz"
