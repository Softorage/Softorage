...
info: "A plotting library for the Python programming language"
...
get_it:
  - ["Authentic", "https://matplotlib.org/users/installing.html"]
...
source:
  description: ["https://en.wikipedia.org/w/index.php?title=Matplotlib&oldid=878974242", "https://matplotlib.org"]
  ...
  rating:
    - ["SourceForge", "u", "https://sourceforge.net/projects/matplotlib/reviews/"]
...
---
  * Although not required, it is suggested to also install [IPython](/softwares/ipython) for interactive use.([source](https://matplotlib.org/users/installing.html))